...
function interrupter (interruptingWord) {
  return function (sentence) {
    ...
    let newStr = ""//make a new string to add the  interrupters

   for (let i = 0; i < words.length; i++){// iterate through words array
    ...
    if (i === words.length - 1) {
      ...
      newStr += word + ' ' + interruptingWord + " "
      //first iteration newStr = how what // are what // you
    }
